...
123 placed components (excluding test pads and mounting holes), 48 unique LCSC line items.
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{lXrr}
        ...
        Inductors & 11 values (0603 RF + 3030 power), CC1200 matching & 16 & 1.12 \\
        ...
        \midrule
        \textbf{LCSC subtotal} & (incl. MOQ rounding for passives) & & \textbf{28.44} \\
        \bottomrule
    \end{tabularx}
    \caption{MOTOR\_RF\_HAT on-board component cost breakdown.}
    \label{tab:bom-onboard}
\end{table}

Items not on LCSC, sourced separately:
...
\begin{table}[H]
    ...
    \begin{tabular}{lrr}
        ...
        Component & Qty & \euro{} \\
        \midrule
        SMA edge-mount connectors & 2 & 1.50 \\
        15~nH 0603 inductor & 2 & 0.50 \\
        Raspberry Pi Pico (hand-soldered) & 1 & 4.00 \\
        \midrule
        \textbf{Non-LCSC subtotal} & & \textbf{6.00} \\
        \bottomrule
    \end{tabular}
    \caption{Items sourced outside LCSC.}
    \label{tab:bom-non-lcsc}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{lr}
        ...
        Item & \euro{} \\
        \midrule
        Bare PCB (4-layer, JLCPCB, per board from 5-piece order) & 6.00 \\
        \bottomrule
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{llrr}
        ...
        \midrule
        FAPG36-555-EN motor (24~V, 516:1) & AliExpress & 2 & 16.00 \\
...
\begin{table}[H]
    ...
    \begin{tabular}{lr}
        ...
        Non-LCSC parts (SMA, 15~nH, Pico) & 6.00 \\
        Bare PCB (4-layer) & 6.00 \\
    ...
    \label{tab:bom-grand-total}
\end{table}

Excludes antenna, coax cable, 24~V power supply, and tripod (user-supplied). Hand-assembled --- no JLCPCB PCBA fees. LCSC total includes MOQ rounding (buying 100 passives when 1--8 are needed). The combined MOTOR\_RF\_HAT board eliminates the separate motor controller PCB and USB cable between Pi and rotator used in v1 testing. Numbers are projections for the unfabricated v2 board.
