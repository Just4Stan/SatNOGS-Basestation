...
The frequency sweep covered 430--439\,MHz in 1\,MHz steps with 50 packets per direction per frequency (1000 total). Test conditions: 1\,m board separation, wire dipole antennas, indoor lab, CRC-16 enabled. Table~\ref{tab:devboard-bench} shows the per-frequency results averaged over both directions.
