...
\begin{enumerate}
    ...
    \item Battery feasible? Architecturally yes (zero motor current when stationary, 24~V input accepts a 6S LiPo). Analytical projection: $\sim$3.5~W idle + $\sim$18~W peak active, weighted $\sim$90\,\% idle $\to$ 20--28~h on a 6S 6~Ah (133~Wh) pack. Not field-validated; see \S\ref{sec:future-work}.
\end{enumerate}
