...
\begin{itemize}
    ...
    \item Because the system is interference-dominated rather than thermally limited, the primary benefit of a mast-mounted LNA is that its gain ($\sim$20~dB) lifts the received antenna signal above the fixed board-interference floor before it reaches the CC1200, improving the signal-to-noise ratio at the CC1200 input by approximately the LNA gain. A secondary benefit is the reduction of the thermal noise figure from $\sim$7~dB (CC1200 alone) to $<$1~dB (LNA-dominated Friis cascade). The combined effect improves effective sensitivity by $\sim$20~dB, which would move the AetherSpace 30\degree/600~km link margin from the measured $\sim$$-$21~dB towards break-even.
