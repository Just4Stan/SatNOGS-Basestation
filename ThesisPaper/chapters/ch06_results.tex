...
\begin{table}[H]
    ...
    \begin{tabular}{rrrrr}
        ...
        \bottomrule
        \multicolumn{5}{l}{\footnotesize $^\dagger$ Integer-N PLL boundary artefact; see text.}
    \end{tabular}
...
The elevated RSSI at 430 and 435\,MHz is a measurement artefact. At these exact 5\,MHz multiples the CC1200 frequency word has \textsc{freq1}\,=\,\textsc{freq0}\,=\,\texttt{0x00}, placing the fractional-N synthesiser at an integer-N boundary where the sigma-delta modulator is not dithering. The resulting lower phase noise, combined with the RSSI sample being taken immediately after packet reception before the running average has decayed to the ambient floor, produces the apparent peaks.
