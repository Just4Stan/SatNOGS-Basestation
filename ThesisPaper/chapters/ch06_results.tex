...
\paragraph{F. MIMAN AX.100 Mode~5 analysis (inconclusive).} MIMAN captures processed through AX.100 Mode~5 achieved Golay(24,12) decode rates of 73\,\% (April 9) and 66\,\% (April 12). The random false-positive baseline for Golay(24,12) with 3-error correction is approximately 57\,\%, so the observed rates are only marginally above chance. Zero frames passed the subsequent RS(255,223) correction. Golay matches without downstream RS-decoded content are not a definitive indicator.
