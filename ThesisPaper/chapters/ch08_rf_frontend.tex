...
The key rule is that no splits or voids in the groundplane are allowed under RF lines, as this would disrupt the current return path, increase loop area, and lead to additional radiation and impedance discontinuities.
