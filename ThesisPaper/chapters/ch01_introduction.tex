...
\begin{itemize}
    ...
    \item \textbf{Robbe Lehaen}: RF front-end hardware (dual CC1200 transceiver HAT, UHF 433~MHz assembled + VHF 144/145~MHz routed), matching network design, RF HAT firmware (COBS protocol, SPI driver), CC1200 register configuration.
\end{itemize}
