...
A single 24~V bench supply (or 6S LiPo for portable operation) feeds the motor PCB's 24~V H-bridge rail directly and is dropped to 5~V on each board independently: an LMR51420 on the RF HAT and a TPS560430 on the motor PCB. The 5~V rail of the motor PCB also supplies the Pi through the GPIO header. Splitting the buck converters this way isolates the noisy motor-driver switching node from the RF receive front-end, which would otherwise see the buck switching harmonics directly at 433~MHz.
