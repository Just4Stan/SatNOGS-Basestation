...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{llcl>{\raggedright\arraybackslash}X}
        ...
        \textbf{This work} & \textbf{Open-source} & \textbf{$<$50} & \textbf{$<$0.1\degree} & \textbf{ASA 3D-printed, geared DC motors, EasyComm} \\
        \bottomrule
    \end{tabularx}
...
This thesis builds on Hanssens' 2023 study, which surveyed SatNOGS, assessed antenna options, and tested a Stepperdrive MSD-50-5.6D stepper motor. His finding: the stepper could not deliver enough torque for reliable azimuth rotation under wind loading. This motivated our switch to high-torque geared DC motors.
...
Our design combines: (a) ASA 3D-printed journal bearings with no purchased bearing components, (b) 516:1 internally geared DC motors with zero idle current, and (c) full SatNOGS compatibility via EasyComm, verified with live satellite passes.
