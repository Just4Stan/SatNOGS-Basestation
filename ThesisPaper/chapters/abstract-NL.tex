...
Een Python-stack op de Pi verzorgt passagevoorspelling, Dopplercorrectie, per-satelliet CC1200-herconfiguratie en indiening van SiDS-telemetrie. Een HTTPS-dashboard biedt telefoon- of laptop-gestuurd veldbeheer. Het station spreekt standaard EasyComm III via hamlib.

Over drie veldsessies werden ongeveer 210 satellietpassages gevolgd met een Siretta Oscar 44 Yagi. De CC1200-ontvangstketen is gevalideerd voor lokale testframes in korteafstandstests tussen twee CC1200-transceivers op de grond, maar geen protocol-geldige frames werden uit baan gedecodeerd.
