...
Across three field sessions, approximately 210 satellite passes were tracked with a Siretta Oscar 44 Yagi. The CC1200 receive chain was validated for local test frames in short-range ground-to-ground CC1200-to-CC1200 tests but no protocol-valid frames were decoded from orbit. Board-level interference (buck converter harmonics, RP2040 digital noise, Pi GPIO emissions) elevates the effective noise floor approximately 30~dB above the thermal\,+\,NF baseline, degrading the CC1200 sensitivity from its datasheet $-$120~dBm to approximately $-$105~dBm and leaving the AetherSpace link at $-$20.7~dB measured margin at 30\degree\ elevation. The link-budget analysis identifies a mast-mounted LNA as the dominant remaining sensitivity gap. The v2 MOTOR\_RF\_HAT (combined controller/RF board) is design-complete but not yet fabricated at submission.
